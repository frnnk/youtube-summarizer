"""Generic helpers (non-module).

Pure functions with no project dependencies — safe to import directly from any
module. Keeps URL parsing and text wrangling out of the feature modules.
"""
...
def extract_video_id(url: str) -> str:
    ...
    and a raw id passed directly. Raises ``ValueError`` if no id can be found.
    """
